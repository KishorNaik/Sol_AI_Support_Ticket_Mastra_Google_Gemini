...
export interface ICreateProgrammingLanguageMapEntityService
	extends IServiceHandlerAsync<CreateProgrammingLanguageRequestDto, ProgrammingLanguageEntity> {}

@sealed
@Service()
export class CreateProgrammingLanguageMapEntityService
	implements ICreateProgrammingLanguageMapEntityService
{
	public handleAsync(
		params: CreateProgrammingLanguageRequestDto
