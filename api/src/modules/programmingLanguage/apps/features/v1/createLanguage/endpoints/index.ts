...
import { CreateProgrammingLanguageRequestDto, CreateProgrammingLanguageResponseDto } from '../contracts';
...
export class CreateProgrammingLanguageEndpoint {
  ...
  public async postAsync(@Body() request: CreateProgrammingLanguageRequestDto, @Res() res: Response) {
...
// #region Command
@sealed
export class CreateProgrammingLanguageCommand extends RequestData<ApiDataResponse<CreateProgrammingLanguageResponseDto>> {
...
export class CreateProgrammingLanguageCommandHandler implements RequestHandler<CreateProgrammingLanguageCommand, ApiDataResponse<CreateProgrammingLanguageResponseDto>> {
  ...
  public constructor(){
    this._createProgrammingLanguageMapEntityService = Container.get(CreateProgrammingLanguageMapEntityService);
    this._createProgrammingLanguageDbService = Container.get(CreateProgrammingLanguageDbService);
    this._createProgrammingLanguageMapResponseService= Container.get(CreateProgrammingLanguageMapResponseService);
  }

  public async handle(value: CreateProgrammingLanguageCommand): Promise<ApiDataResponse<CreateProgrammingLanguageResponseDto>> {
    ...
    try
    {
      ...
      await this.pipeline.step(PipelineSteps.MAP_ENTITY_SERVICE,async ()=>{
        const result = await this._createProgrammingLanguageMapEntityService.handleAsync(request);
        return result;
      });
      ...
      await this.pipeline.step(PipelineSteps.DB_SERVICE,async ()=>{
        ...
        const mapEntityResult = this.pipeline.getResult<CreateProgrammingLanguageRequestDto>(PipelineSteps.MAP_ENTITY_SERVICE);
      ...
      await this.pipeline.step(PipelineSteps.MAP_RESPONSE_SERVICE,async ()=>{
        ...
        const dbServiceResult = this.pipeline.getResult<CreateProgrammingLanguageRequestDto>(PipelineSteps.DB_SERVICE);

        // Map Response
        const result = await this._createProgrammingLanguageMapResponseService.handleAsync(dbServiceResult);
        return result
      ...
      await queryRunner.commitTransaction();
       ...
       // Return
      const response = this.pipeline.getResult<CreateProgrammingLanguageResponseDto>(PipelineSteps.MAP_RESPONSE_SERVICE);
      return DataResponseFactory.success(StatusCodes.CREATED, response, `Programming Language created successfully`);
